...
def load_data():
    data = {
        "Animal": ["Chien", "Chat", "Lion", "Éléphant", "Requin", "Loup", "Vache", "Serpent"],
        ...
        "Dangerosité": [3, 2, 9, 7, 8, 6, 1, 9], # Note sur 10
        "Caractéristiques": [
...
page = st.sidebar.radio("Aller vers :", ["Chatbot", "Recherche & Caractéristiques", "Dashboard Analytics"])
...
if page == "Chatbot":
    ...
    if prompt := st.chat_input("Posez une question (ex: Qui aboie ?)"):
        ...
        response = "Désolé, je n'ai pas cette information."
...
# --- PAGE 2 : RECHERCHE PAR CARACTÉRISTIQUES ---
